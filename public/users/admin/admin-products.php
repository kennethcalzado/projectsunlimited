...
<script>
    ...
    $.ajax({
        ...
        success: function(categories) {
            ...
            categoryFilter.append($('<option>').prop('disabled', true).prop('selected', true).text('Filter by Category'));
            $.each(categories, function(index, category) {
    ...
    $.ajax({
        ...
        success: function(brands) {
            ...
            brandFilter.empty();
            brandFilter.append($('<option>').prop('disabled', true).prop('selected', true).text('Filter by Brand'));
            $.each(brands, function(index, brand) {

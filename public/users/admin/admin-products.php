                ...
                if (data.length > 0) {
                    data.forEach(product => {
                        ...
                        tr.innerHTML = `
                            ...
                            <td>
                            <button id="editProduct" class="" data-id="${product.id}">View</button>
                            <button id="addProduct" class="" data-id="${product.id}">Edit</button>
                            <button id="deleteProduct" class="" data-id="${product.id}">Delete</button>
                            </td>
                        `;

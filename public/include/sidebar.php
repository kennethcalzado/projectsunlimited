...
<span id="toggle-sidebar" class="fixed text-white text-4xl top-5 z-40 ml-4 cursor-pointer burger"
    onclick="toggleSidebar()">
    <i class="bi bi-filter-left px-2 bg-gray-900 rounded-md" title="Toggle Sidebar"></i>
</span>

<div
    class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[80px] overflow-y-auto text-center bg-black text-white minimized transition-all">

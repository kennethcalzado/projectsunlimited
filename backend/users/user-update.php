...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['userId'], $_POST['firstName'], $_POST['lastName'], $_POST['email'], $_POST['roleId'])) {
        $userId = $_POST['userId'];
        ...
        // Perform the update query including the role ID
        $sql = "UPDATE users SET fname = ?, lname = ?, email = ?, role_id = ? WHERE user_id = ?";
